...
// 			LevelManager LLM = (LevelManager) target;

// 			GUILayout.Space (10.0f);
// 			EditorGUILayout.LabelField ("Level Data Persistence", EditorStyles.boldLabel);

// 			LLM._clearOnStart = EditorGUILayout.Toggle (new GUIContent ("Reset Scene", "Clears the scene and loads Initial Scene."), LLM._clearOnStart);
...
// 				{
// 					LLM.SaveLevel (_levelsList[i]);
// 				}
// 				if (GUILayout.Button ("Load"))
// 				{
// 					LLM.LoadLevel (_levelsList[i]);
// 					LLM.DeleteLevel (_levelsList[i]);
// 				}
// 				GUI.skin.button.normal.textColor = new Color (1.0f, 0.2f, 0.2f, 1.0f);
// 				if (GUILayout.Button (new GUIContent ("Delete", "Deletes the level file permanently!")))
// 				{
// 					LLM.DeleteLevel (_levelsList[i]);
// 				}
