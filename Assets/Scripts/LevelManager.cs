...
namespace ManagerClasses
{
	public class LevelManager : MonoBehaviour
	{
		...
		[FoldoutGroup ("Prefabs")][SerializeField] Transform _blockHolder;
		[FoldoutGroup ("Prefabs")][SerializeField] Transform _botHolder;
		[Header ("Prefabs")]
		[FoldoutGroup ("Prefabs")][SerializeField] List<Block> _blockList;
		...
		[ToggleGroup ("_clearOnStart", order : 0, groupTitle: "Initial level ")][SerializeField] bool _clearOnStart;
		...
		void GenerateLevel (LevelData levelData_)
		{
			...
			foreach (LevelObjectData lod in levelData_._levelObjects)
			{
				...
				else
				{
					...
					if (iLevelObj.IsPlaceable) _PlaceableBlocks.Add (iLevelObj.GetTransform.GetComponent<Block> ());
				}
			}
	...
	public class LevelData
	{
		...
		[Button] public void SaveLevel () { LevelManager.instance.SaveLevel (_levelName); }

		[HorizontalGroup ("Level Data Persistence Options")]
		[Button] public void LoadLevel () { LevelManager.instance.LoadLevel (_levelName); }
